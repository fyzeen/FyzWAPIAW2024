...
def map_yeo(results, dictionary):
    ...
    for dataset in dataset_list:
        results.loc[results['Dataset'] == "HCP_YA", 'Yeo'] = results['IDP_name'].map(mappings[dataset])
    yeo_mapping = {
        1: "Visual",
        2: "Somatomotor",
        3: "Dorsal Attention",
...
aseg_out_path = "/Users/fyzeen/FyzeenLocal/GitHub/FyzWAPIAW2024/regression_outputs/HCP_YA_asegYeo_sexConfound/HCP_YA_asegYeo_sexConfound.csv"
dkt_out_path = "/Users/fyzeen/FyzeenLocal/GitHub/FyzWAPIAW2024/regression_outputs/HCP_YA_dktYeo_sexConfound/HCP_YA_dktYeo_sexConfound.csv"
...
#plt.show()
plt.savefig("/Users/fyzeen/FyzeenLocal/GitHub/FyzWAPIAW2024/regression_outputs")
