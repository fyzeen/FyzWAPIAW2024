#!/bin/bash -l
#SBATCH --job-name=HCP_YA_dktYeo_noConfounds
#SBATCH --account=janine_bijsterbosch
#SBATCH --output="/scratch/l.lexi/WAPIAW2024/Experiments/HCP_team/hcp_ya/logs/HCP_YA_dktYeo_noConfounds.out%j"
#SBATCH --error="/scratch/l.lexi/WAPIAW2024/Experiments/HCP_team/hcp_ya/logs/HCP_YA_dktYeo_noConfounds.err%j"
...
outname="HCP_YA_dktYeo_noConfounds"
